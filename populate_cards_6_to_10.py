...
def add_cards():
    ...
    add("Spécialisation", 9, "Purple", ["Factory", "Leaf", "Factory"], "Factor", "Montrez une carte de votre Main. Transférez la carte Active de vos adversaires ayant la même couleur vers votre Main. Vous pouvez décaler vos cartes jaunes ou bleues en haut.")
    ...
    print(f"Populated {len(cards)} cards (Total).")
